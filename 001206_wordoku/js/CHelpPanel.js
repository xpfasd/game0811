function CHelpPanel(){
    ...
    this._init = function(){
        ...
        _oText0 = new createjs.Text(TEXT_HELP0," 140px "+SECONDARY_FONT, "#ffffff");
        ...
        _oText0Page2 = new createjs.Text(TEXT_HELP0_PAGE2," 140px blackplotan", "#ffffff");
        ...
        _oText1Page2 = new createjs.Text(_oMessage,"bold 35px "+PRIMARY_FONT, "#ffffff");
        ...
        _oText2Page2 = new createjs.Text(TEXT_HELP2_PAGE2,"bold 35px "+PRIMARY_FONT, "#ffffff");
        ...
        _oText3Page2 = new createjs.Text(TEXT_HELP3_PAGE2,"bold 35px "+PRIMARY_FONT, "#ffffff");
        ...
        _oText4Page2 = new createjs.Text(TEXT_HELP4_PAGE2,"bold 35px "+PRIMARY_FONT, "#ffffff");
